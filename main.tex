...
\captionof{figure}{Screenshot of Demo Scene and Scene Menu.}
\label{demo-pic}
\hfill \break
\end{minipage}
...
\end{lstlisting}
\captionof{figure}{Code snippet for choosing scene.}
\label{scene_script}
\end{minipage}
...
\captionof{figure}{Screenshot of trigger associated with selecting scene.}
\label{demo-trigger}
\hfill \break
\end{minipage}
