...
\hfill \break
\centering
\includegraphics[width=0.8\textwidth]{images/gloves2}
\captionof{figure}{Image taken on Samsung Gear 360. This is the image used to inspect the gloves item, it is used in 360-image environment.}
\label{model}
\hfill \break
\end{minipage}
